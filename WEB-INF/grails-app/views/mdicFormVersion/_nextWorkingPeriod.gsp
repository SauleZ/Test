<div class="sg-table-caption">Следующий период (на '<g:formatDate date="${dtCurrent}" format="yyyy-MM-dd HH:mm" />' ) сдачи отчетов:
</div>
<div class="sg-property-value" >${infoAboutCalendarNext} </div>

<div class="sg-table-caption">
    Используются нижеследующие сгенерированные справочники для следующего Периода :
</div>
...
<table>
    ...
    <tbody>
    <g:each in="${calendarSpravNextList}" status="i" var="calendar">
